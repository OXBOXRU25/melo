...
<div class="modal modal-parent modal-succes">
    <div class="modal__inner">
        <div class="modal-box">
            ...
            <?php /* В тексте темы было «времяи» — слипшиеся слова. */ ?>
            <p class="modal__text">
                Наш менеджер свяжется с вами в ближайшее время<br>
                и уточнит дополнительные детали.
            </p>
        ...
        <?php /* Фотография из окна «Спасибо» убрана по решению заказчика
                 14.09.2026: окно теперь белое, только текст и крестик. */ ?>
    </div>
</div>
