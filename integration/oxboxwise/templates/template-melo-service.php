...
<div class="melo-page">
	...
	<section class="hero">
		...
		<div class="container hero__inner">
			...
			*/
			...
			<button class="btn btn--gold open-modal-os" type="button"
	...
	<section class="section section--gray" id="melo-what">
		<div class="container">
	...
	<!-- ============ 3. Как мы работаем ============ -->
	<section class="section section--gray" id="melo-steps">
		<div class="container">
	...
	<section class="section section--gray" id="melo-works">
		<div class="container">
			<div class="section__head section__head--center" data-reveal>
			...
			<div class="works__cta">
				<a class="btn btn--navy btn--wide" href="<?php echo esc_url( home_url( '/projects/' ) ); ?>">
					Все проекты
					<svg class="btn__arrow" aria-hidden="true"><use href="#melo-i-arrow"></use></svg>
				</a>
			</div>
		</div>
	</section>
