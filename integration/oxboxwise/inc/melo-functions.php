...
function melo_socials( $class = 'melo-socials' ) {
	...
	$telegram = '<path fill="currentColor" d="M21.9 3.8 2.6 11.2c-.7.3-.7 1.3 0 1.5l4.8 1.6 1.8 5.6c.2.7 1.1.8 1.5.3l2.6-3 4.8 3.6c.5.3 1.1.1 1.3-.5l3.4-15c.2-.7-.5-1.3-1.1-1.1zM9.4 14.3l8.4-5.6-6.9 6.8-.3 3.1-1.2-4.3z"/>';

	/* Знак MAX по присланному заказчиком оригиналу: кольцо с вырезанным
	   внутри пузырём, у пузыря хвостик влево-вниз. */
	$max = '<path fill="currentColor" fill-rule="evenodd" d="M12.4 1.1a11.1 11.1 0 1 0 0 22.2c2.9 0 5.6-1.1 7.6-3l-.1-.1a11.1 11.1 0 0 0-7.5-19.1zM12.3 6.2a5.8 5.8 0 1 1 0 11.6c-1 0-1.9-.2-2.7-.6l-.1.1c-.6.6-1.3 1-2.1 1.2-.5.1-.9-.3-.8-.8.2-.8.3-1.6.2-2.4a5.8 5.8 0 0 1 5.5-9.1z"/>';
