 ...
 *
 * Ключ ниже лежит в репозитории открытым текстом. Перед КАЖДОЙ заливкой
 * скрипта на сервер меняйте его на новый: пока файла на сервере нет,
 * ключ ничего не значит, а пока есть — он единственная защита.
 */
